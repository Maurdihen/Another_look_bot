...
class NotesService:
    ...
    def create_note(self, user_id: int, date: str, time: str, category: str, subcategory: str) -> Notes:
        return self.notes_dao.create_note(user_id, date, time, category, subcategory)
    ...
    def update_note(self, note_id: int, date: str, time: str, category: str, subcategory: str) -> Notes:
        return self.notes_dao.update_note(note_id, date, time, category, subcategory)
